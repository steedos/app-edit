...
export const getType = (type: string) => (state: RootState) =>
  getTypes(state)[type]

export const getComponent = (type: string) => (state: RootState) => {
  const t = getType(type)(state)
  return t && t['component']
}

export const getPreviewComponent = (type: string) => (state: RootState) => {
  const t = getType(type)(state)
  if (!t) {
    return null
  }
...
export const getSettingsComponent = (type: string) => (state: RootState) => {
  const t = getType(type)(state)
  return t && t['componentSettings']
}

export const getComponentProps = (type: string) => (state: RootState) => {
  const t = getType(type)(state)
  return t && t['componentProps']
}

export const getDroppable = (type: string) => (state: RootState) => {
  const t = getType(type)(state)
...
export const getCustomValueTypes = (state: RootState) =>
  state.types.customValueTypes
